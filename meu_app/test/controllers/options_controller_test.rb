...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference("Option.count") do
      post options_url, params: { option: { correct: @option.correct, question_id: @option.question_id, text: @option.text } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { correct: @option.correct, question_id: @option.question_id, text: @option.text } }
