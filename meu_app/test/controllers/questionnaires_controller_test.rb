...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference("Questionnaire.count") do
      post questionnaires_url, params: { questionnaire: { code: @questionnaire.code, description: @questionnaire.description, duration_minutes: @questionnaire.duration_minutes, title: @questionnaire.title, user_id: @questionnaire.user_id } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { code: @questionnaire.code, description: @questionnaire.description, duration_minutes: @questionnaire.duration_minutes, title: @questionnaire.title, user_id: @questionnaire.user_id } }
